  ...
  try {
    ...
    const ideas = [
      [
        1,
        'Leaf Art',
        'Collect leaves and make nature patterns.',
        20,
        'easy',
        'Leaves, glue, paper',
        'nature',
      ...
      [
        2,
        'Math Treasure Hunt',
        'Solve riddles hidden around the playground.',
        30,
        'medium',
        'Paper, markers',
        'math',
      ...
      [
        1,
        'Indoor Story Circle',
        'Kids tell stories using prompts.',
        15,
        'easy',
        'None',
        'language',
    ...
    for (const comment of comments) {
      await db.query('INSERT INTO comments (idea_id, user_id, text) VALUES (?, ?, ?)', comment);
    }
    ...
    for (const fav of favorites) {
      await db.query('INSERT IGNORE INTO idea_favorites (user_id, idea_id) VALUES (?, ?)', fav);
    }
