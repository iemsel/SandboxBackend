...
const ideas = [
  // 1. Leaf art for younger kids – sunny, simple
  {
    ...
    min_age: 6,
    max_age: 9,
    image_url: 'https://media.istockphoto.com/id/914559116/photo/abstract-green-background-flora-mandala-pattern-wild-climbing-vine-liana-plant-with.jpg?s=612x612&w=0&k=20&c=DBUOf42y2c22C5xE6t0-yLyU6iTOiQiI8JiOdb6z2Mg=',
  ...
  // 2. Rainy indoor nature – worm detectives at the window / schoolyard
  {
    ...
    min_age: 7,
    max_age: 10,
    image_url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7iDnckZTRGamWCVA1utXQHbEl-kmlSLM4KA&s',
  ...
  // 5. Balcony Bird Café – great for parents at home too
  {
    ...
    min_age: 6,
    max_age: 11,
    image_url: 'https://i.ytimg.com/vi/B9tx_PHHIDI/hq720.jpg?sqp=-oaymwE7CK4FEIIDSFryq4qpAy0IARUAAAAAGAElAADIQj0AgKJD8AEB-AH-CYAC0AWKAgwIABABGGUgXyg6MA8=&rs=AOn4CLAMYsUsoCbnnz-zFhp7qqxGcK35AQ',
  ...
  // 6. Litter Heroes – clean-up & citizenship
  {
    ...
    min_age: 8,
    max_age: 12,
    image_url: 'https://www.ncw.co.uk/wp-content/uploads/2022/01/family-litter-picking-beach-dunes.jpg',
  ...
  // 8. Rainy Day Sound Walk – can be done in covered area or hallway
  {
    ...
    min_age: 8,
    max_age: 11,
    image_url: 'https://i.guim.co.uk/img/media/09da4fa03734265ebc5986dc08bdb6a5a0a6abfc/167_125_1642_985/master/1642.jpg?width=1200&quality=85&auto=format&fit=max&s=f7d60461ded4ea23b80c19c06c2afddc',
  ...
  // 9. Bug Hotel Builders – older kids, more tools / materials
  {
    ...
    min_age: 9,
    max_age: 12,
    image_url: 'https://brigitsgarden.ie/wp-content/uploads/2022/02/Cropped_Bug_Hotel_Final_Product-e1652788335631.jpg',
  ...
  // 10. Weather Diary at Home – parents + kids, minimal tools
  {
    ...
    min_age: 7,
    max_age: 11,
    image_url: 'https://img.freepik.com/free-photo/cute-girl-drawing-paper-bed_23-2148070466.jpg?semt=ais_hybrid&w=740&q=80',
  ...
  // 11. Recycled Robot Competition – big creative project
  {
    ...
    min_age: 9,
    max_age: 12,
    image_url: 'https://cdn.shopify.com/s/files/1/0857/2946/files/playful.childhood_robot_10_1024x1024.jpg?v=1720419481',
  ...
  // 12. Mindful Tree Time – calm outdoor exercise
  {
    ...
    min_age: 8,
    max_age: 12,
    image_url: 'https://d2gesac5hma2c2.cloudfront.net/uploads/production/picture/image/31615/cropped_landscape_lg_600_tree3.jpg',
