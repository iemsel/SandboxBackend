...
const ideas = [
  // 1. Leaf art for younger kids – sunny, simple
  {
    ...
    min_age: 6,
    max_age: 9,
    image_url: 'https://example.com/leaf-mandala.jpg',
  ...
  // 2. Rainy indoor nature – worm detectives at the window / schoolyard
  {
    ...
    min_age: 7,
    max_age: 10,
    image_url: 'https://example.com/worm-detectives.jpg',
  ...
  // 3. Tiny Forest treasure hunt – classic Dutch green schoolyard vibe
  {
    ...
    min_age: 7,
    max_age: 11,
    image_url: 'https://example.com/tiny-forest-hunt.jpg',
  ...
  // 4. Polder water engineers – very NL, STEM + water management
  {
    ...
    min_age: 9,
    max_age: 12,
    image_url: 'https://example.com/polder-engineers.jpg',
  ...
  // 5. Balcony Bird Café – great for parents at home too
  {
    ...
    min_age: 6,
    max_age: 11,
    image_url: 'https://example.com/bird-cafe.jpg',
  ...
  // 6. Litter Heroes – clean-up & citizenship
  {
    ...
    min_age: 8,
    max_age: 12,
    image_url: 'https://example.com/litter-heroes.jpg',
  ...
  // 7. Shadow Math Game – sunny, younger classes
  {
    ...
    min_age: 7,
    max_age: 10,
    image_url: 'https://example.com/shadow-math.jpg',
  ...
  // 8. Rainy Day Sound Walk – can be done in covered area or hallway
  {
    ...
    min_age: 8,
    max_age: 11,
    image_url: 'https://example.com/sound-walk.jpg',
  ...
  // 9. Bug Hotel Builders – older kids, more tools / materials
  {
    ...
    min_age: 9,
    max_age: 12,
    image_url: 'https://example.com/bug-hotel.jpg',
  ...
  // 10. Weather Diary at Home – parents + kids, minimal tools
  {
    ...
    min_age: 7,
    max_age: 11,
    image_url: 'https://example.com/weather-diary.jpg',
  ...
  // 11. Recycled Robot Competition – big creative project
  {
    ...
    min_age: 9,
    max_age: 12,
    image_url: 'https://example.com/recycled-robot.jpg',
  ...
  // 12. Mindful Tree Time – calm outdoor exercise
  {
    ...
    min_age: 8,
    max_age: 12,
    image_url: 'https://example.com/mindful-tree.jpg',
