  ...
  try {
    ...
    const plans = [
      {
        ...
        date: '2025-03-15',
        class_name: 'Class A',
        notes: 'Outdoor activities focusing on nature',
      },
      {
        owner_id: 2,
        title: 'Math Workshop',
        date: '2025-03-20',
        class_name: 'Group B',
        notes: 'Fun indoor math challenges',
      },
    ];
    ...
    const items = [
      ...
      },
      {
        plan_id: planIds[0],
        idea_id: null,
        custom_title: 'Healthy Snack Break',
        custom_description: 'Fruits and water',
        start_time: '10:30:00',
        end_time: '10:45:00',
        location: 'Cafeteria',
      },
      ...
      },
      {
        plan_id: planIds[1],
        idea_id: 3,
        custom_title: 'Story Time',
        custom_description: 'Storytelling session with kids',
        start_time: '14:00:00',
        end_time: '14:30:00',
        location: 'Library',
      },
